...
<style>
    ...
    .field-label {
        font-family: 'Plus Jakarta Sans', sans-serif;
        font-weight: 600; font-size: 12.5px; color: var(--dark);
    ...
    .status-toggle-wrap {
        ...
        padding: 16px 18px;
        background: #FAFBFD; border-radius: 11px;
        border: 1.5px solid var(--border);
    }
    ...
    .btn-save-menu {
        ...
        transition: all 0.2s;
        box-shadow: 0 4px 14px rgba(46,196,182,0.28);
    }
    .btn-save-menu:hover {
    ...
    .btn-cancel-menu {
        ...
        color: var(--dark); border-radius: 11px;
        font-family: 'Plus Jakarta Sans', sans-serif;
        ...
        <div class="form-card">
            <div class="form-card-header">
                <div class="form-card-icon" style="background:rgba(46,196,182,0.12);">
                    <i class="bi bi-journal-plus" style="color:var(--tosca);"></i>
                </div>
...
function updateStatusLabel() {
    ...
    document.getElementById('statusDesc').textContent  = checked
        ? 'Menu akan muncul di halaman transaksi'
